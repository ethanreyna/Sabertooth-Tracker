...
export const emptyDb = (): DB => ({ settings: { guildCutPct: DEFAULT_GUILD_CUT_PCT }, members: [], roles: [], jobs: [], barrels: [], dungeons: [], spots: [], ledger: [], bankItems: [], suggestions: [], items: [], enchantments: [], enchants: [], projects: [] });
  ...
  dungeons: [
    {
      ...
      recommended: 2, chests: 3, status: 'active', respawnMinutes: 0, lastCleared: '', difficulty: 'Moderate', x: '', y: '',
    ...
    },
    {
      ...
      recommended: 3, chests: 2, status: 'active', respawnMinutes: 0, lastCleared: '', difficulty: 'Easy', x: '', y: '',
