...
export const demoDb = (): DB => ({
  ...
  jobs: [
    {
      ...
      description: 'The guild forge is running dry. Bring iron ingots to the quartermaster; payout split by contribution once we hit 40.',
      postedBy: 'Karina', postedAt: d(3), deadline: f(10), status: 'open', claimedBy: '',
      collection: true, items: ['40 iron ingots'],
      entries: [
  ...
  barrels: [
    { id: 'b1', owner: 'Waxillius Scadrian', paid: true, rate: 150, start: d(5), end: f(9), notes: 'Riverwood \u2014 behind the smithy, third barrel', img: '', at: d(5) },
    { id: 'b2', owner: 'Hide the Mute', paid: false, rate: 150, start: d(2), end: f(12), notes: 'Whiterun \u2014 by the guild cellar door', img: '', at: d(2) },
  ],
  ledger: [
    ...
    { id: 'l3', type: 'income', amount: 300, desc: 'Barrel rent \u2014 Waxillius, 2 weeks', by: 'Zahir Alazar', at: d(4) },
