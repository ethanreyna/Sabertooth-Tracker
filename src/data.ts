  ...
  dungeons: [
    {
      ...
      recommended: 2, chests: 3, status: 'active', respawnDays: 0, lastCleared: '', difficulty: 'Moderate', x: '', y: '',
    ...
    },
    {
      ...
      recommended: 3, chests: 2, status: 'active', respawnDays: 0, lastCleared: '', difficulty: 'Easy', x: '', y: '',
